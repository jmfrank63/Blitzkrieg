...
# would otherwise strand the run on the win screen. The three post-win
# clicks below were located by screenshot, at the render's native
# 1440x900 (see the `shot`-written .rgba's own name):
...
schedule="$schedule,2100:click=718x495,2200:click=1200x825,2300:click=1180x825,2500:shot,2600:exit"
