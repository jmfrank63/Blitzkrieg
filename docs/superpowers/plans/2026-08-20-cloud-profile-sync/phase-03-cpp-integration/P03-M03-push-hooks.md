# P03-M03 — post-save and exit push
...
- [ ] Trigger a sync after a save completes, honouring `Cloud.Sync.OnSave`, and coalesce bursts: three autosaves in a minute are one sync, not three.
