...
**Allowed files:** `docs/superpowers/evidence/cloud-sync/p07-m03-linux.md`.
...
- [ ] Check behaviour on a case-sensitive filesystem — profile names are compared case-insensitively by `NProfile::NameEquals` on the assumption of APFS and NTFS, and ext4 does not share it.
