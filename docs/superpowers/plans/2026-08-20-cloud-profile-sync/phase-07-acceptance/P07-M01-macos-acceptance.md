...
**Allowed files:** `docs/superpowers/evidence/cloud-sync/p07-m01-macos.md`.
...
- [ ] Confirm the daemon dies with the game, and that a killed game leaves an orphan that the next launch reaps.
...
- [ ] Restore a config backup in merge mode and confirm the local display settings survive.
...
**Evidence:** Evidence file records commands, timings, screenshots, and explicit human approval.
