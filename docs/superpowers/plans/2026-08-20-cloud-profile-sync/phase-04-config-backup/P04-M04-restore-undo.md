...
- [ ] Export `bk_cloudsync_restore_undo() i32` and `bk_cloudsync_restore_undo_available() u32`, with undo branching on which of the two states it finds. Own the whole export path.
