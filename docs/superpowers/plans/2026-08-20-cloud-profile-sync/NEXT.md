...
Resume at `phase-04-config-backup/P04-M03-restore-merge.md`.

**Phases 00 through 03 are complete; P04-M01 and P04-M02 are done.** Phase 00's gate is met
...
zig build test-cloudsync-backup  -Dtest-mode=run    #  4 (3 live with BK_TEST_RCLONE)
...
**Next:** `phase-04-config-backup/P04-M03-restore-merge.md` — the staged
restore with the GFX-preserving merge.
