...
- [x] Convert `Misc::Thread` to the canonical portable `NPlatform::Event`/`NPlatform::Mutex` synchronization facade without changing its public engine behavior.
