...
- **GOLD Parser**: Using v2.06 (registered from `Sources\sdk\GOLDParser\GOLD Parser Engine.dll`)
...
## Key Decisions Log
- **2024-05-18**: Updated Parser.cpp to use the current GOLD Parser COM API (changed `LoadCompiledGrammar` and `OpenFile` signatures)
...
- **2024-05-18**: Fixed ShaderParser.cpp GetTokens calls for the current GOLD Parser COM API
