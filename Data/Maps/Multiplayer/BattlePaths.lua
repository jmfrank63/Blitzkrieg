...
local num;
	if (nParty == 0) then
		if (GetNUnitsInPlayerUF(0) < 16) then
			num = RandomInt(6) + 100;
			LandReinforcement(num);
		end;
		if (GetNUnitsInPlayerUF(1) < 16) then
			num = RandomInt(6) + 200;
			LandReinforcement(num);
		end;
	end;
	if (nParty == 1) then
		if (GetNUnitsInPlayerUF(2) < 16) then
			num = RandomInt(6) + 300;
			LandReinforcement(num);
		end;
		if (GetNUnitsInPlayerUF(3) < 16) then
			num = RandomInt(6) + 400;
			LandReinforcement(num);
		end;
	end;
