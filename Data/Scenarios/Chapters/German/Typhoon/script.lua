...
local bScenario = GetIGlobalVar("Mission.scenarios\\scenariomissions\\german\\typhoon\\1.Finished", 0);
...
--Medal Conditions(tank_assault)
	if ((GetStatisticsValue (3, 0) <= 600) and (HasMedal("Medals\\German\\tank_as2\\1") == 0)) then
		AddMedal("Medals\\German\\tank_as2\\1", 4);
	end;
end;
