function Objective0()
	if ( GetNUnitsInScriptGroup(11, 1) <= 0) then
		SetIGlobalVar("temp.template02.objective.0", 1);
...
function Objective1()
	if ( GetNUnitsInScriptGroup(12, 1) <= 0) then
		SetIGlobalVar("temp.template02.objective.1", 1);
...
function Objective2()
	if ( GetNUnitsInScriptGroup(13, 1) <= 0) then
		SetIGlobalVar("temp.template02.objective.2", 1);
...
function Objective3()
	if ( GetNUnitsInScriptGroup(17, 1) <= 0) then
		SetIGlobalVar("temp.template02.objective.3", 1);
...
function Objective4()
	if ( GetNUnitsInScriptGroup(15, 1) <= 0) then
		SetIGlobalVar("temp.template02.objective.4", 1);
...
function ToWin()
	if ( (GetIGlobalVar("temp.template02.objective.0", 0) * GetIGlobalVar("temp.template02.objective.1", 0) * GetIGlobalVar("temp.template02.objective.2", 0) *
	  GetIGlobalVar("temp.template02.objective.3", 0) * GetIGlobalVar("temp.template02.objective.4", 0)) == 1) then
		Win(0);
		Suicide();
	end;
end;
...
function Init()
	...
	RunScript( "RevealObjective3", 18000);
	RunScript( "RevealObjective4", 23000);
