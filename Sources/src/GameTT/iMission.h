...
enum
{
	...
	MISSION_INTERFACE_CLOUD_SHUTDOWN									= MISSION_BASE_VALUE + 263,
	MISSION_COMMAND_CLOUD_SHUTDOWN										= MISSION_BASE_VALUE + 264,
...
enum EMissionCommands
{
	...
	MC_ZOOM_IN							= 0x00200074,
	MC_ZOOM_OUT							= 0x00200075,
